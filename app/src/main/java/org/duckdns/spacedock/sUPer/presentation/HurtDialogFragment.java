...
//TODO implémenter meilleure méthode de communication avec l'activité via une interface que l'activité implémentera et qui contiendra une méthode de callback. Actuellement dépendant de la classe spécifique de l'activité
     ...
     */
    private final DialogInterface.OnClickListener HurtDialogListener = new DialogInterface.OnClickListener()
    {
        public void onClick(DialogInterface dialog, int id)
        {
            //TODO: la ligne suivante bien que d'une concision admirable fait trop à la fois, la diviser pour plus de clarté
            activity.HurtInflictedCallback(m_index, Integer.parseInt(m_DamageEditText.getText().toString()));//on passe à l'activité les dégâts reçus
        }
    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        View statSetupView = activity.getLayoutInflater().inflate(R.layout.fragment_hurt_dialog, null);//TODO: voir si il est possible de passer autre chose que null comme rootelement
        ...
        builder.setPositiveButton(R.string.DialogModify, HurtDialogListener);
